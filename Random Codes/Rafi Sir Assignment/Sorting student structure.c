/*
    ...
    Problem Number : 1
    Problem : Write a code to sort the elements firstly according to num of problems solved. If number of
              problems solved is equal then according to cgpa, if cgpa is equal then according to their registration number.
*/
#include <stdio.h>
